module fabscreen/obico-webrtc

go 1.24.0

require github.com/pion/webrtc/v4 v4.2.20

// anet v0.0.5 links to Go's removed net.zoneCache symbol on Android/ARM.
// Artisan is Android 10 (API 29), where anet itself delegates to net.*.
